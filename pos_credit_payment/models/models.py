...
# class pos_credit_payment(models.Model):
#     _name = 'pos_credit_payment.pos_credit_payment'
#     _description = 'pos_credit_payment.pos_credit_payment'
    ...
    def _accumulate_amounts(self, data):
        ...
        for order in self.order_ids:
            ...
            if order.is_invoiced:
                ...
                print("oeder: ", order,"payment_ids : ",order.payment_ids)

                key = order.partner_id
                if self.config_id.cash_rounding:
                    invoice_receivables[key] = self._update_amounts(invoice_receivables[key], {'amount': invoice_amount}, order.date_order)
                else:
                    invoice_receivables[key] = self._update_amounts(invoice_receivables[key], {'amount': invoice_amount}, order.date_order)
                # side loop to gather receivable lines by account for reconciliation
                print("invoice_receivables : ",invoice_receivables)
